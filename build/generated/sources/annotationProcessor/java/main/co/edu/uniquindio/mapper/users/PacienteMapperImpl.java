...
public class PacienteMapperImpl implements PacienteMapper {
    ...
    @Override
    public Paciente toEntity(RegistrarPacienteDto registrarPacienteDto) {
        if ( registrarPacienteDto == null ) {
            return null;
        }

        Paciente paciente = new Paciente();

        paciente.setUser( crearUserDtoToUser( registrarPacienteDto.crearUserDto() ) );
        paciente.setNombre( registrarPacienteDto.nombre() );
        paciente.setTelefonos( registroTelefonoDtoListToTelefonoList( registrarPacienteDto.telefonos() ) );

        paciente.setCitas( new java.util.ArrayList<>() );
        paciente.setFormulasMedicas( new java.util.ArrayList<>() );
    ...
    @Override
    public void updateEntity(EditarPacienteDto editarPacienteDto, Paciente paciente) {
        if ( editarPacienteDto == null ) {
            return;
        }

        paciente.setNombre( editarPacienteDto.nombre() );
    }
    ...
    private Long pacienteEpsId(Paciente paciente) {
        Eps eps = paciente.getEps();
        if ( eps == null ) {
            return null;
        }
        return eps.getId();
